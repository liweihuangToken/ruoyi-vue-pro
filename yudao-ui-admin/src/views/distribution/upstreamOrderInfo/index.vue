  ...
  <div class="app-container">
    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="100px">
      ...
      <el-form-item label="供应商名称" prop="upstreamName">
        <el-input v-model="queryParams.upstreamName" style="width: 260px" placeholder="请输入供应商名称" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="供应商简称" prop="upstreamAlias">
        <el-input v-model="queryParams.upstreamAlias" style="width: 260px" placeholder="请输入供应商简称" clearable @keyup.enter.native="handleQuery"/>
      </el-form-item>
      <el-form-item label="取货方式" prop="pickupMethod">
        <el-select v-model="queryParams.pickupMethod" style="width: 260px" placeholder="请输入取货方式" clearable size="small">
          <el-option v-for="dict in this.getDictDatas(DICT_TYPE.DISTRIBUTION_PICKUP_METHOD)"
    ...
    <el-table border height="680" header-align="center" v-loading="loading" :data="list">
      ...
      <el-table-column label="供应商名称" align="center" prop="upstreamName" min-width="80px"/>
      <el-table-column label="供应商简称" align="center" prop="upstreamAlias" min-width="80px"/>
      <el-table-column label="取货方式" align="center" prop="pickupMethod" min-width="80px">
        <template v-slot="scope">
          <dict-tag :type="DICT_TYPE.DISTRIBUTION_PICKUP_METHOD" :value="scope.row.deliveryMethod" />
        </template>
      </el-table-column>
...
import {
        ...
        getUpstreamOrderPage,
        } from "@/api/distribution/orderDetailInfo";
import ImagePreview from "@/components/ImagePreview";

export default {
  name: "UpstreamOrderDetailInfo",
  components: {
    ImagePreview
  },
  data() {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      // 执行查询
      getUpstreamOrderPage(this.queryParams).then(response => {
